    ...
    const mockLeads: Lead[] = [
      {
        ...
        source: 'tiktok',
        type: 'service',
        comment: 'SYSTEM - I need this for my agency',
        username: '@sarahbiz2024',
      ...
      },
      {
        ...
        source: 'tiktok',
        type: 'service',
        comment: 'AI - How much for something like this?',
        username: '@techceo_mike',
