...
const data = [
  { name: 'Viral Hits', value: 35, color: '#8B4B5C' },
  { name: 'High Engagement', value: 40, color: '#10B981' },
  { name: 'Medium Performance', value: 20, color: '#3B82F6' },
  { name: 'Low Performance', value: 5, color: '#6B7280' },
]
