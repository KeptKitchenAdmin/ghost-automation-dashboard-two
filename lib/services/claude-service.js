...
class ClaudeService {
    ...
    checkDailyLimits(estimatedCost, estimatedTokens) {
        this.resetDailyLimitsIfNeeded();
    ...
    updateDailyUsage(actualCost, actualTokens) {
    ...
    async enhanceStory(story, targetDurationMinutes = 5) {
    ...
    buildEnhancementPrompt(story, targetDurationMinutes) {
...
ClaudeService.dailyUsageCount = 0;
ClaudeService.dailyUsageCost = 0;
ClaudeService.lastResetDate = new Date().toDateString();
ClaudeService.DAILY_LIMITS = {
